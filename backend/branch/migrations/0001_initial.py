# Generated by Django 5.1.3 on 2024-11-23 04:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(max_length=200, on_delete=django.db.models.deletion.CASCADE, to='branch.city', verbose_name='شهر')),
            ],
        ),
        migrations.CreateModel(
            name='MarketFeature2',
            fields=[
                ...
                ('info', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='markets_one', to='branch.marketfeature1')),
            ],
        ),
        migrations.CreateModel(
            name='MarketImages',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('market', models.ManyToManyField(blank=True, related_name='users', to='branch.marketfeature2')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='market',
            name='province',
            field=models.ForeignKey(max_length=200, on_delete=django.db.models.deletion.CASCADE, to='branch.province', verbose_name='استان'),
        ),
        migrations.AddField(
            model_name='city',
            name='province',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cities', to='branch.province'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('market', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='marketTimeSlots', to='branch.market')),
                ('market1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='time_slots', to='branch.marketfeature2', verbose_name='مارکت اول')),
            ],
            options={
